...
** It could have been more minimal with a larger time investment
...
** Posting an issue quickly was a priority
...
** Ruling out the library underlying [[file:20210326110802-persistent.org][Persistent]] ( [[file:20210326121125-postgresql_simple.org][postgresql-simple]]) had the same issue
